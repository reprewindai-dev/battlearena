    ...
    <Card className="spitzone-panel p-5">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="space-y-2">
          <div className="spitzone-kicker">Growth loop</div>
          <div>
          ...
          <div className="rounded-[1.2rem] border border-white/10 bg-black/20 px-4 py-3 text-sm text-white/85">
            {inviteLink}
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3 lg:min-w-[280px]">
          ...
          <Button onClick={() => void copyInviteLink()} className="rounded-full bg-primary text-black hover:bg-[#ffd071]">
